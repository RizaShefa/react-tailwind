...
const Footer = () => {
  return (
        ...
        <footer
          className="flex justify-around font-sans-pro text-amber-50 text-sm xl:text-xl md:text-md sm:p-0"
        >
          <div className="flex gap-3">
            <p className="p-2">writinngs.dev</p>
            <p className="bg-blue-400 rounded-sm p-1">by @kamrify</p>
          </div>
          <div>
            <div className="flex gap-2 items-center bg-blue-400 rounded-sm p-1">
              <svg
                width="20"
                height="16"
                viewBox="0 0 20 16"
              ...
              <p className="p-1">follow @writinngsdev</p>
            </div>
          </div>
        </footer>
